...
parser.add_argument('--case', help='Reinforcement learning case considered. Choose one from the following list: "1", or "4"', required=True, type=str)
...
#e["Solver"]["Reward"]["Outbound Penalization"]["Enabled"] = True # KORALI VERSION
